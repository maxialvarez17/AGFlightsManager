        ...
        public ICollection<Aircraft> Aircrafts
        {
            get
            {
                return new List<Aircraft>()
                {
                    ...
                    new Aircraft() { Id = 2, Description = "Boeing CE-453", TakeOffConsumption = 58, KmConsumption = 16 },
                    new Aircraft() { Id = 3, Description = "Boeing RF-567", TakeOffConsumption = 65, KmConsumption = 15 },
                    new Aircraft() { Id = 4, Description = "Boeing ER-083", TakeOffConsumption = 57, KmConsumption = 14 },
                    new Aircraft() { Id = 5, Description = "Boeing RE-340", TakeOffConsumption = 62, KmConsumption = 12 }
                };
            }
        }
    }
